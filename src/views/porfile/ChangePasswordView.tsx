...
import { UpdateCurrentUserPasswordForm } from "@/types/authTypes";
        ...
        >
          <div className="mb-5 space-y-3">
            ...
            {errors.current_password && (
              <Errors>{errors.current_password.message}</Errors>
            )}
          </div>
          ...
          <div className="mb-5 space-y-3">
            ...
            {errors.password_confirmation && (
              <Errors>{errors.password_confirmation.message}</Errors>
            )}
          </div>
